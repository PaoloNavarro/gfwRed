...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="row d-flex justify-content-center">Administrar empleo</h1>
                            <br>
                            <br>
                            <div class="row">
                                <form action="" method="post">
                                    ...
                                    placeholder="Añadir" value="Añadir empleo">
                                    <br>
                                    <div>
                                       <table class="pt-5 mt-5 table table-striped text-center align-middle">
                                                    <thead>
                                                        <tr>
                                                            <th>Nombre<i class="bi bi-credit-card"></i></th>
                                                            <th>Detalle <i class="bi bi-x-diamond-fill"></i></th>
                                                            <th>Editar<i class="bi bi-flag"></i></th>
                                                            <th>Eliminar<i class="bi bi-calendar"></i></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php while($row = $result->fetch_assoc()){?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                        ...
                                                                        <a href="controlador/procesos.php?edit=<?php echo $row['id']; ?>"
