<?php 
    ...
    $restult3 =  $conexion->query("SELECT * FROM usuriao where pais='$pPais'");
    $restult4 =  $conexion->query("SELECT * FROM usuariosprueba where pais='$pPais' and estado='Activo'");
...
<h1 class="row d-flex justify-content-center">Solicitud de registros</h1>
                                ...
                                <form action="" method="post">
                                    ...
                                    <div>
                                       <table class="table table-striped text-center align-middle">
                                                    ...
                                                    <tbody>
                                                        <?php while($row = $restult4->fetch_assoc()){?>
                                                            <tr>
                                                                <td><?php echo $row['nombre'],' ',$row['apellido'],' Rol: ',$row['cargo']?></td>
                                                                <td><?php echo $row['fecha_n']?></td>
                                                                <td><?php echo $row['correo']?></td>
                                                                <td>
                                                                     <a href="controlador/procesoFR1.php?create=<?php echo$row['id']?>" 
                                                                   class="btn btn-success">Guardar</a>


                                                                </td>
                                                                <td>
                                                                    <a href="controlador/procesosFR.php?delete=<?php echo$row['id']?>" 
