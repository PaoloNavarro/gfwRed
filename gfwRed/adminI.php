...
<html lang="en">
  ...
  <body>
    ...
    <main class="container pt-5 mt-5 pb-5 mb-5">
                    <h1 class="row  text-center align-middle"><?php
                            if($_SESSION["pais"]=="SV"){
                             echo "Bienvenido a la red de empleo de El Salvador";
                                                    }
                        elseif($_SESSION["pais"]=="GT"){
                             echo "Bienvenido a la red de empleo de Guatemala";
                                                
                                                    }
                        elseif($_SESSION["pais"]=="HN"){
                             echo "Bienvenido a la red de empleo de Honduras";
